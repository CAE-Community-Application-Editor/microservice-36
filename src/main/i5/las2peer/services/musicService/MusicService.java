...
public class MusicService extends RESTService {
  ...
  @SwaggerDefinition(
      info = @Info(title = "36", version = "$Metadata_Version$",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/CAE-Community-Application-Editor/microservice-36/blob/master/LICENSE.txt") ) )
  @Path("/")
   ...
   *
   * 
   * @param payloadSong  a JSONObject
   * 
   * @return Response 
   * 
   */
  ...
  public Response postSong(String payloadSong) {
    JSONObject payloadSong_JSON = (JSONObject) JSONValue.parse(payloadSong);
    ...
    try {
        ...
        String songTitle = (String) payloadSong_JSON.get("title");

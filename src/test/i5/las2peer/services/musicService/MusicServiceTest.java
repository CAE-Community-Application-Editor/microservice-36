 ...
 * 36 - Test Class
 *
 * This class provides a basic testing framework for the microservice 36. It was
...
public class MusicServiceTest {
  ...
  public void testpostSong() {
    ...
    try {
      JSONObject payloadSong = new JSONObject();
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("POST", mainPath + "/songs", payloadSong.toJSONString(),
